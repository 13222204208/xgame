		...
		<div class="layui-col-md12" style="padding: 30px;">
			<form class="layui-form" action="" style="width: 60%;">
				...
				<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="int1" value="<?php echo ($item['f_int1']); ?>" class="layui-input" style="width: 100px;display: inline-block;">
							%
						</div>
					</div>
				...
				<div class="layui-form-item">
						...
						<div class="layui-input-block">
							总赢分<input type="text" name="int2" value="<?php echo ($item['f_int2']); ?>" class="layui-input" style="width: 100px;display: inline-block;">
							
						</div>
					</div>

					<div class="layui-form-item">
							<label class="layui-form-label">系点数限红</label>
							<div class="layui-input-block">
								<input type="text" name="int3" value="<?php echo ($item['f_int3']); ?>" class="layui-input" style="width: 500px;display: inline-block;">
								
							</div>
						</div>
						<div class="layui-form-item">
								<label class="layui-form-label">全豹子限红</label>
								<div class="layui-input-block">
									<input type="text" name="int4" value="<?php echo ($item['f_int4']); ?>" class="layui-input" style="width: 500px;display: inline-block;">
									
								</div>
							</div>

							<div class="layui-form-item">
									<label class="layui-form-label">指定豹子限红</label>
									<div class="layui-input-block">
										<input type="text" name="int5" value="<?php echo ($item['f_int5']); ?>" class="layui-input" style="width: 500px;display: inline-block;">
