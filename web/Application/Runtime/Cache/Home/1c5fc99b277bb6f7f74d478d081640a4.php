		...
		<div class="layui-col-md12" style="padding: 30px;">
			<form class="layui-form" action="" style="width: 60%;">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						庄家<input type="text" name="int6" value="<?php echo ($item['f_int6']); ?>" class="layui-input" style="width: 80px;display: inline-block;">倍抢庄且牛
						<input type="text" name="int7" value="<?php echo ($item['f_int7']); ?>" class="layui-input" style="width: 80px;display: inline-block;">以上通杀
					</div>
				</div>
