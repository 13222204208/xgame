		...
		<div class="layui-col-md12" style="padding: 30px;">
			<form class="layui-form" action="" style="width: 60%;">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						总赢分<input type="text" name="int2" value="<?php echo ($item['f_int2']); ?>" class="layui-input" style="width: 80px;display: inline-block;">
					</div>
				</div>
				<div class="layui-form-item">
						<label class="layui-form-label">1赔24限红</label>
						<div class="layui-input-block">
							<input type="text" name="int3" value="<?php echo ($item['f_int3']); ?>" class="layui-input" style="width: 80px;display: inline-block;">
						</div>
					</div>

					<div class="layui-form-item">
							<label class="layui-form-label">1赔8限红</label>
							<div class="layui-input-block">
								<input type="text" name="int4" value="<?php echo ($item['f_int4']); ?>" class="layui-input" style="width: 80px;display: inline-block;">
							</div>
						</div>

								<div class="layui-form-item">
						<label class="layui-form-label">1赔4限红</label>
						<div class="layui-input-block">
							<input type="text" name="int5" value="<?php echo ($item['f_int5']); ?>" class="layui-input" style="width: 80px;display: inline-block;">
						</div>
					</div>
					<div class="layui-form-item">
							<label class="layui-form-label">1赔3限红</label>
							<div class="layui-input-block">
								<input type="text" name="int6" value="<?php echo ($item['f_int6']); ?>" class="layui-input" style="width: 80px;display: inline-block;">
							</div>
						</div>

						<div class="layui-form-item">
								<label class="layui-form-label">1赔2限红</label>
								<div class="layui-input-block">
									<input type="text" name="int7" value="<?php echo ($item['f_int7']); ?>" class="layui-input" style="width: 80px;display: inline-block;">
								</div>
							</div>
							<!-- <div class="layui-form-item">
									<label class="layui-form-label">1赔1限红</label>
									<div class="layui-input-block">
										<input type="text" name="int7" value="<?php echo ($item['f_int7']); ?>" class="layui-input" style="width: 80px;display: inline-block;">
									</div>
								</div> -->
								<div class="layui-form-item">
										<label class="layui-form-label">彩球限红</label>
										<div class="layui-input-block">
											<input type="text" name="int8" value="<?php echo ($item['f_int8']); ?>" class="layui-input" style="width: 80px;display: inline-block;">
										</div>
									</div>
				<div class="layui-form-item">
						<div class="layui-input-block">
