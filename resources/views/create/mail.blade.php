...
<!-- 				<div class="layui-form-item">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="EndTime" id="test2" value="" class="layui-input" style="width: 350px;display: inline-block;">
				...
				<div class="layui-form-item">
					<label class="layui-form-label">自动领取</label>
					<div class="layui-input-block">
						<input type="radio" name="IsAuto" lay-skin="primary" title="是" value="1" checked="">
						<input type="radio" name="IsAuto" lay-skin="primary" title="否" value="0" checked="checked">
					</div>
				</div>
<!-- 				<div class="layui-form-item">
