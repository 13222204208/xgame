					...
					success: function(res) {
						...
						if (res == '{"status":200}') {
							layer.msg('添加成功', {
								...
								location.href = "{{url('/game/three-colour')}}";
							});
						} else {
							console.log(res);
							layer.msg('添加失败', {
